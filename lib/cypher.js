module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c0 = peg$FAILED,
        peg$c1 = "MATCH",
        peg$c2 = { type: "literal", value: "MATCH", description: "\"MATCH\"" },
        peg$c3 = "RETURN",
        peg$c4 = { type: "literal", value: "RETURN", description: "\"RETURN\"" },
        peg$c5 = "a",
        peg$c6 = { type: "literal", value: "a", description: "\"a\"" },
        peg$c7 = function(pat) {
        ...
        peg$c13 = function(id) { return { id:id } },
        peg$c14 = [],
        peg$c15 = /^[a-z]/,
        peg$c16 = { type: "class", value: "[a-z]", description: "[a-z]" },
        peg$c17 = function(p) { return p; },
        peg$c18 = function(paths) { return paths; },
        peg$c19 = function(first, relationship) { return flatten([ first, relationship ]); },
        peg$c20 = null,
        peg$c21 = function(nodeid, labels, properties) { return { id:nodeid, labels:labels, properties:properties }; },
        peg$c22 = "<",
        ...
        peg$c28 = function(backward, relData, forward, path) { 
        ...
        peg$c33 = function(nodeid, type, properties) { return { id:nodeid, type:type, properties:properties }; },
        peg$c34 = ":",
        ...
        peg$c40 = function(value) { return value; },
        peg$c41 = "{",
        ...
        peg$c58 = function(JSmembers) { return JSmembers !== null ? JSmembers: {}; },
        peg$c59 = function(name, value) {
              return { name: name, value: value };
            },
        peg$c60 = function(v) { return v; },
        peg$c61 = function(first, rest) { return [first].concat(rest); },
        peg$c62 = function(values) { return values !== null ? values : []; },
    ...
    function peg$parseRelationshipData() {
      var s0, s1, s2, s3, s4, s5;
    ...
    function peg$parsebegin_JSobject() {
      var s0, s1, s2, s3;
    ...
    function peg$parseend_JSobject() {
      var s0, s1, s2, s3;
    ...
    function peg$parseJSobject() {
      var s0, s1, s2, s3, s4, s5, s6, s7;

      s0 = peg$currPos;
      s1 = peg$parsebegin_JSobject();
      if (s1 !== peg$FAILED) {
        s2 = peg$currPos;
        s3 = peg$parseJSmember();
        if (s3 !== peg$FAILED) {
          s4 = [];
          s5 = peg$currPos;
          s6 = peg$parsevalue_separator();
          if (s6 !== peg$FAILED) {
            s7 = peg$parseJSmember();
            if (s7 !== peg$FAILED) {
              peg$reportedPos = s5;
              s6 = peg$c56(s7);
              s5 = s6;
